...
## Video demo link
The narrated source video is committed at **`demo/claimscene-demo.mp4`** (2:35,
...
- 521 backend tests plus 295 frontend tests and 19 real-browser specs, gitleaks, CodeQL and a machine-checkable readiness gate, all runnable with zero credentials.
